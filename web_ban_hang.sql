...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2023 at 02:17 AM
...
(1, 'Táo ngôi sao lạ mắt, quýt 300.000 đồng/quả dịp Tết', 'Quýt chum chĩnh vàng, táo hình ngôi sao, bưởi đỏ tiến vua... dù có giá đắt đỏ, nhưng vẫn thu hút khách hàng mua làm quà biếu Tết hoặc dâng hương với mong muốn một năm mới tiền tài rủng rỉnh cho gia chủ.', 'Quýt chum chĩnh vàng\n Giống như tên gọi độc đáo của mình, quýt chum có hình dạng như một chĩnh vàng tròn đầy, mang ý nghĩa tài lộc và may mắn. Quýt chum có nguồn gốc từ Nhật Bản, Hàn Quốc, được một số cửa hàng hoa quả nhập khẩu đưa về Việt Nam trong một vài năm trở lại đây.', '../img/tintuc1.webp', '2022-10-10'),
...
INSERT INTO `user` (`username`, `password`, `fullname`, `age`, `sdt`, `id`) VALUES
('001', '123', 'Hoang Van Son', 19, '0123456789', 1),
('002', '123', 'Nguyen Thi A', 20, '0123456789', 2),
('003', '123', 'Duong Van C', 28, '0123456789', 3),
('004', '123', 'Ho Thi D', 16, '0123456789', 4),
('005', '123', 'Nguyen Van G', 18, '01234', 5);
